            ...
            <section className="card-row worker-grid">
              <div className="card">
                ...
                <p className="narrative">
                  When heavy rain or curfews hit, your delivery hours drop. GigShield watches your zone in real time
                  and automatically protects the income you would have earned.
                </p>
              ...
              <div className="card">
                ...
                <ul className="scope-list">
                  ...
                  <li>No health, accident, or vehicle repair coverage</li>
